...
def test_make_contract_honors_explicit_equity_contract_override():
    with patch.dict("scripts.daily_update.EQUITY_CONID_OVERRIDES", {"TEST": 42}):
        contract = _make_contract("TEST", "equity")
